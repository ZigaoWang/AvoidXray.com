      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            {/* The byline, under the copyright rather than filed between
                Guidelines and Source Code in the About column — where it was
                the one line in a column of links that was not a link, so it
                broke the rhythm of that column and read as a menu item that
                did nothing. It is a credit, so it sits with the brand and is
                allowed to be seen: the name in white, underlined in the brand
                red the rest of the site uses to mark what can be followed. */}
            <p className="mt-4 text-sm text-neutral-500">
              ...
              <a
                ...
                className="font-medium text-white underline decoration-brand decoration-2 underline-offset-4
